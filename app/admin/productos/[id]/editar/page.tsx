...
export default function EditarProductoPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    try {
      ...
      if (data) {
        setFormData({
          ...
          precio_comparacion: data.precio_comparacion?.toString() || '',
          categoria: data.categoria || 'camisetas',
          color: data.color || '',
          caracteristicas: data.caracteristicas?.length > 0 ? data.caracteristicas : [''],
          tipo_guia_talles: data.tipo_guia_talles || 'mujer',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (existingProduct) {
        alert('Ya existe otro producto con este slug. Por favor usa un nombre diferente.');
        setIsSaving(false);
        return;
      }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <h1 className="text-2xl lg:text-3xl font-medium">Editar Producto</h1>
                  ...
                  <div key={index} className="space-y-2">
                    ...
                    {imagen.src && (
                      <div className="pl-4">
                        <img 
                          src={imagen.src} 
                          alt={imagen.etiqueta || `Imagen ${index + 1}`}
